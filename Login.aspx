<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Projectkz.Login" %>
<!DOCTYPE html>
...
<body>
   <div class="loginbox" >
       ...
       <h2>Log in here</h2>
       <form runat="server">
         <asp:Label Text="User Name" CssClass="lb1email" runat="server" />
           ...
           <asp:TextBox ID="TextBox1" runat="server" CssClass="txtemail" placeholder="Enter UserName"></asp:TextBox>
